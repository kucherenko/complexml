...
/**
 * Вырезает из строки html/xml теги
 */
class CompleXml_Filter_StripTags extends CompleXml_Filter_Abstract
{
    /**
     * Unique ID prefix used for allowing comments
     */
    const UNIQUE_ID_PREFIX = '__CompleXml_Filter_StripTags__';
    /**
    ...
    public function setTagsAllowed ($tagsAllowed)
    {
        ...
        foreach ($tagsAllowed as $index => $element) {
            ...
            } else // Otherwise, if a tag was provided with attributes
     ...
     *
     * @param  array|string $attributesAllowed
     * @return CompleXml_Filter_StripTags Provides a fluent interface
     */
    ...
    /**
     * Defined by CompleXml_Filter_Abstract
     *
     * @param  string $value
     * @return string
     */
